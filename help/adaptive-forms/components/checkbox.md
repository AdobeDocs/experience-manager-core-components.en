...
-  **Preserve Uncheck state value**- Selecting this option allows you to specify the value to be returned when the checkbox component is not selected.. If **Preserve Uncheck state value** is enabled or set to true, **When Unchecked, return value** option appears.
