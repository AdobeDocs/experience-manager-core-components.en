...
-   **Options** - You can add data values and display text pairs using the **Add** button. You can also format the options for radiobutton group using **Allow Rich Text for Options**. 
