...
The Adaptive Forms Telephone input Core Component was released in Feb 2023 as part of the Core Components 2.0.4. Here's a table showing all supported versions, AEM compatibility, and links to corresponding documentation:
...
The Design Dialog is used to define and manage CSS styles for a component. The Adaptive Forms Telephone input Core Component supports the AEM [Style System](/help/get-started/authoring.md#component-styling).
