...
*   **Allowed Heading Elements**: A drop-down menu with multiple options that lets the author choose which HTML elements can be used as headings for accordion items.
