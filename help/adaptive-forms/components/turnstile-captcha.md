---
title: Turnstile Captcha in AEM Adaptive Forms
...
![Turnstile](/help/adaptive-forms/assets/turnstile-challenge.png)

## Usage {#usage}

There are several reasons why it is beneficial to include a turnstile mechanism in a form submission process, including:

- **Bot Prevention**: Turnstiles, like CAPTCHAs, ensure that the form is being submitted by a human, reducing spam and automated submissions.

- **Security**: Turnstiles can add an extra layer of security, verifying the legitimacy of each form submission and protecting against malicious attacks.

- **Data Integrity**: By preventing multiple or fraudulent submissions, turnstiles help maintain the integrity and accuracy of the data collected through the form.

- **User Verification**: Turnstiles can be used to verify the identity of the user submitting the form, ensuring that only authenticated users can complete sensitive transactions.

- **Load Management**: Turnstiles help manage server load by controlling the rate of form submissions, preventing system overload during high-traffic periods.

## Version and Compatibility {#version-and-compatibility}


The Adaptive Forms Turnstile Captcha released in June 2024 as part of the Core Components 3.0.28. Here's a table showing all supported versions, AEM compatibility, and links to corresponding documentation:
