...
>[!NOTE]
>
>v1 of the page component does not support page redirection. Please use the [current version of the page component](/help/components/page.md) for page redirection support.
...
Because the component represents the entire page, settings that would normally be in an edit dialog are found in the [Page Properties](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/sites/authoring/authoring/editing-page-properties) window.
