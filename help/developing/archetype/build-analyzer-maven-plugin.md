...
| `configuration-api`  | Validates important OSGi configurations. <p>&nbsp;</p><p> `Configuration org.apache.felix.webconsole.internal.servlet.OsgiManager: Configuration is not allowed (com.mysite:mysite.all:1.0.0-SNAPSHOT|com.mysite:mysite.ui.config:1.0.0-SNAPSHOT)` </p> | Yes  | Yes  |
