...
+ Adaptive Forms {#adaptive-forms}
  ...
  + Adaptive Forms Components {#adaptive-forms-components}
    ...
    + {hide-from-toc} [Adaptive Forms Image Choice](/help/adaptive-forms/components/image-choice.md)
    ...
    + {hide-from-toc} [Adaptive Form Review](/help/adaptive-forms/components/review.md)
  ...
  + {hide-from-toc} [Enable Text Input Validation Patterns](/help/adaptive-forms/enable-validation-patterns.md)
