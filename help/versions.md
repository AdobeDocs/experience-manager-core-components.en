...
|---|---|---|---|---|---|---|
|[2.16.2](https://github.com/adobe/aem-core-wcm-components/releases/tag/core.wcm.components.reactor-2.16.2)|This was a patch release to fix issues related to the Link Handler. Small improvements were also made to PWA.|6.4.8.1+ * |6.5.5.0+ * |Continual|8, 11|15 May 2021|
