...
|---|---|---|---|---|---|---|---|
|[2.9.0](https://github.com/adobe/aem-core-wcm-components/releases/tag/core.wcm.components.reactor-2.9.0)|This release enabled integration with the Adobe Client Data Layer and introduced the Progress Bar component.|6.3.3.4+|6.4.4.0+|6.5.0.0+|Continual|8, 11|29 May 2020|
