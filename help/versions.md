...
|---|---|---|---|---|---|---|
|[2.15.2](https://github.com/adobe/aem-core-wcm-components/releases/tag/core.wcm.components.reactor-2.15.2)|This was a patch release mainly fixing issues with [Data Layer](/help/developing/data-layer/overview.md) backward compatibility and IT tests failing in certain situations.|6.4.8.1+ * |6.5.5.0+ * |Continual|8, 11|17 March 2021|
