...
The current release of the Core Components is 2.14.0 and is compatible with [AEM as a Cloud Service](https://docs.adobe.com/content/help/en/experience-manager-cloud-service/landing/home.html) and [on-premise AEM](https://docs.adobe.com/content/help/en/experience-manager-65/user-guide/home.html) installations.
...
|---|---|---|---|---|---|---|
|[2.15.0](https://github.com/adobe/aem-core-wcm-components/releases/tag/core.wcm.components.reactor-2.15.0)|This release includes support for progressive web apps in the [Page Component](/help/components/page.md) and supports version 2.0 of the [Adobe Data Layer.](/help/developing/data-layer/overview.md)|6.4.8.1+ * |6.5.5.0+ * |Continual|8, 11|23 February 2021|
